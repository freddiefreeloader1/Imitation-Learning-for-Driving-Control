...
from preprocessing.split_helper import split_data
import yaml
import os 
...
def process_files_in_folder(track_data=None):
    ...
    trajectory_folders = ['data/03_05_2024', 'data/04_05_2024', 'data/05_05_2024']
    ...
    for folder_path in trajectory_folders:
        for idx, folder_name in enumerate(os.listdir(folder_path)):
            ...
            output_path = "data/preprocessed/all_trajectories.yaml"
            # with open(output_path, "w") as output_file:
            #     yaml.dump(all_states, output_file)

            print(f"All preprocessed trajectories saved to: {output_path}")
