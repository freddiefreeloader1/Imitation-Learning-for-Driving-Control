...
# Load expert data
expert_data = pd.read_feather('data/expert/all_trajectories_filtered.feather')
...
with open("data_la_human_expert/la_track.yaml", "r") as file:
...
for model in models:
    # Load model data
    model_file = f'data/experiment_sim/model{model}_dist_wrapped.feather'
